...
export type GetCommunitiesQuery = { __typename?: 'Query', communities: Array<{ __typename?: 'Community', id: number, name: string }> };

export type GetVoterAddressesQueryVariables = Exact<{
  houseId: Scalars['Int'];
}>;


export type GetVoterAddressesQuery = { __typename?: 'Query', community: { __typename?: 'Community', auctions: Array<{ __typename?: 'Auction', proposals: Array<{ __typename?: 'Proposal', votes: Array<{ __typename?: 'Vote', address: string }> }> }> } };
